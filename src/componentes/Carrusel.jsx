  ...
  return (
    <Carousel className="background-size-carousel">
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <p className="threeD">Nuestros paquetes vienen con una etiqueta con coloridas imágenes y en bolsa de celofán</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img className="background-img" src={img5} alt="condimentos varios" />
        <Carousel.Caption>
          <p className="threeD">Gran variedad de productos para su preferencia</p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
  );
